data = table2array(readtable("flat_wing_data.txt"));
...
ylabel("lift Force [N]")
title("Flat Wing Plate: Reynolds Number vs. Lift Force")
...
title("Flat Wing Plate: Reynolds Number vs. Lift Coefficient")
