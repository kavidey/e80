...
#define XY_STATE_ESTIMATOR_LOOP_OFFSET 55
#define Z_STATE_ESTIMATOR_LOOP_OFFSET 60
#define DEPTH_CONTROL_LOOP_OFFSET 65
#define SURFACE_CONTROL_LOOP_OFFSET 70
#define LED_LOOP_OFFSET 75
#define LOGGER_LOOP_OFFSET 80
#define SALINITY_OFFSET 85
#endif
